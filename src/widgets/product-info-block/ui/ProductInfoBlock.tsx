...
export function ProductInfoBlock({ product }: { product: ProductType }) {
    ...
    return (
        <div className={styles.productInfo}>
            ...
            {activeTab === "payment" && (
                <div className={styles.infoTextBlock}>
                    ...
                    <ul>
                        ...
                        <li>С выставлением счёта на расчётный счёт компании</li>
            ...
            {activeTab === "delivery" && (
                <div className={styles.infoTextBlock}>
                    <p>Варианты получения заказа:</p>
                    <ul>
                        <li>
                            <strong>Самовывоз со складов</strong> — заберите
                            заказ в удобное время с нашего склада.
                        </li>
                        <li>
                            <strong>Доставка транспортной компанией</strong> —
                            помогаем подобрать перевозчика, предлагаем
                            партнёрские варианты с выгодными условиями.
                        </li>
                    </ul>
                    <p>
                        Оставьте заявку — подберём оптимальный способ доставки и
